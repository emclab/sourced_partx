...
SourcedPartx.index_payment_request_path = "payment_requestx.payment_requests_path(:resource_id => r.id, :resource_string => params[:controller])"
SourcedPartx.index_payment_request_sourced_partx_path = "payment_requestx.payment_requests_path(:resource_id => r.id, :resource_string => params[:controller], :subaction => 'sourced_partx')"
